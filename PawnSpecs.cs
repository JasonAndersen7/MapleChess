...
namespace Chess.Domain
{
    ...
    public class When_using_a_black_pawn_and
    {
        ...
        [Test]
        public void _11_making_an_illegal_move_by_placing_the_black_pawn_on_X_equals_6_and_Y_eqauls_3_and_moving_to_X_equals_4_and_Y_equals_3_should_not_move_the_pawn()
        {
            _chessBoard.Add(_pawn, 6, 3, PieceColor.Black);
